...
| `planner-deepseek-v4.1-flash` | `deepseek/deepseek-v4.1-flash` (reasoning `high`) | openrouter pinned to Together | direct (585 requests), openrouter (477 requests) | [results/planner-deepseek-v4.1-flash/RESULTS.md](results/planner-deepseek-v4.1-flash/RESULTS.md) |
...
|---|---|---|---|---|---|
| **Customer support: cancel because unaffordable** | 9 rows; P 100.0% / R 100.0% / F1 100.0% | 7 rows; P 100.0% / R 77.8% / F1 87.5% | 2 rows; P 100.0% / R 22.2% / F1 36.4%; 6 more gold rows in review view | 3 rows; P 100.0% / R 33.3% / F1 50.0%; 4 more gold rows in review view | 3 rows; P 100.0% / R 33.3% / F1 50.0%; 5 more gold rows in review view |
